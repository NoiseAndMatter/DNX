...
| 2b | Split the rest of `probe/main.ts`. **Started 2026-08-01: `cards.ts` extracted** — the presentation half, which cannot break a device. `ports`/`capture`/`dumpio`/`storageio` remain | **high** for the transports; the renderers were low |
