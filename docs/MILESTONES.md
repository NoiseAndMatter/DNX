...
| When | What | PR |
|---|---|---|
| 2026-07-31 | **The expander writes to the instrument.** A Digitone 1 project is converted and the changed pattern slots go straight into the Digitone II's loaded project — no file, no +Drive, no checksum needed. SAVE PROJECT is the commit. | #86 |
